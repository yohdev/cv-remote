 ...
 */
	...
	$custom_size_image = get_field( 'custom_size_image' );
...
<?php elseif( $button_type == 'custom_image' ): ?>

<div class="custom-vid-btn <?php echo esc_attr($className); ?>">
	<div class="custom-vid-link <?php echo $vid_source; ?> <?php echo $resolution; ?>" vidurl="<?php echo $vid_origin; ?>">
		<?php if( $custom_size_image ): ?>
			<img decoding="async" loading="lazy" class="custom-vid-img" src="<?php echo esc_url($custom_size_image['url']); ?>" alt="<?php echo esc_attr($custom_size_image['alt']); ?>" width="<?php echo esc_attr($custom_size_image['width']); ?>" height="<?php echo esc_attr($custom_size_image['height']); ?>"/>
		<?php endif; ?>
		<div class="vid-title">
			<svg class="vid-btn-icon" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 48 48">
				<path d="M45.9,14.6c-1.2-2.9-3-5.4-5.1-7.7c-2.1-2.2-4.7-3.8-7.6-5.1S27.2,0,23.9,0c-3.2,0-6.3,0.6-9.3,1.9S9.2,4.8,7,6.9
