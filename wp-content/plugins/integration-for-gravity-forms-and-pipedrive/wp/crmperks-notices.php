...
if( !class_exists( 'vxgf_pipedrive_notice' )):
class vxgf_pipedrive_notice{
public $plugin_url="https://www.crmperks.com";
public $review_link='https://wordpress.org/support/plugin/integration-for-gravity-forms-and-pipedrive/reviews/?filter=5#new-post';
public $option='vxg-pipedrive';
public $slug='gf-pipedrive-crm-perks-pro/gf-pipedrive-crm-perks-pro.php';

public function __construct(){

add_action( 'add_section_vxg_pipedrive', array($this,'tab'),10);
add_action( 'add_section_mapping_vxg_pipedrive', array($this,'upgrade_notice'),10);
add_filter( 'plugin_row_meta', array( $this , 'pro_link' ), 10, 2 );

add_action( 'after_plugin_row_'.$this->slug, array( $this, 'plugin_msgs' ) );
add_action( 'wp_ajax_vxg_pipedrive_review_dismiss', array( $this, 'review_dismiss' ) );

if(isset($_GET['page']) && $_GET['page'] == 'gf_edit_forms' && isset($_GET['subview']) && $_GET['subview'] == 'vxg_pipedrive' ){
add_filter( 'admin_footer_text', array( $this, 'admin_footer' ), 1, 2 );
add_filter( 'menu_links_vxg_pipedrive', array( $this, 'menu_link' ), 60 );
add_filter( 'tab_contents_vxg_pipedrive', array( $this, 'tab_pro' ), 60 );
}
...
public function menu_link($links){
    ...
    $logs_link=admin_url( "admin.php?page=gf_edit_forms&view=settings&subview=vxg_pipedrive&tab=go_pro&id={sanitize_text_field('id')}" );
    $links['go_pro']=array( 
  "title"=>__('Go Premium','gravity-forms-pipedrive-crm'),
  "link"=>$logs_link,
...
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Pipedrive Custom fields.</p>
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Pipedrive Phone fields and Marketing Status field.</p>
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Create Leads in Pipedrive CRM.</p>
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Assign Organization to Contact and Deal.</p>
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Create Organizations and Deals in Pipedrive.</p>
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Assign Contact to Pipedrive Deal.</p>
<p><i class="fa fa-check" style="color: #727f30; font-size: 18px; vertical-align: middle;"></i> Assign Owner to Contacts, Organizations and Deals in Pipedrive.</p>
...
<p><b><a href="https://wordpress.org/plugins/integration-for-contact-form-7-and-pipedrive/" target="_blank">Contact Form 7 Pipedrive Integration</a></b> allows you to quickly integrate Contact Form 7 with Pipedrive CRM.</p>
...
$text=sprintf(__( 'if you enjoy using %sGravity Forms Pipedrive%s, please %s leave us a %s rating%s. A %shuge%s thank you in advance.','crm-perks-forms'),'<b>','</b>','<a href="'.$this->review_link.'" target="_blank" rel="noopener noreferrer">','&#9733;&#9733;&#9733;&#9733;&#9733;','</a>','<b>','</b>');
 return $text;
}
public function review_notice() { 
 ...
 if(!empty($install_time) && is_array($install_time) && !empty($install_time['time']) && empty($install_time['review_closed'])){
  ...
  <p><?php echo sprintf(__( 'You\'ve been using %sGravity Forms pipedrive%s for some time now; we hope you love it!.%s If you do, please %s leave us a %s rating on WordPress.org%s to help us spread the word and boost our motivation.','contact-form-entries'),'<b>','</b>','<br/>','<a href="'.$this->review_link.'" target="_blank" rel="noopener noreferrer">','&#9733;&#9733;&#9733;&#9733;&#9733;','</a>'); ?></p>
 ...
 //$.ajax({ type: "POST", url: ajaxurl, async : false, data: {action:"vxcf_form_review_dismiss"} });          
        $.post( ajaxurl, { action: 'vxg_pipedrive_review_dismiss' } );
                });
            });
        </script>
        <?php
