...
?>
<div class="postbox">
<h3><?php esc_html_e('Marketing Data','gravity-forms-pipedrive-crm') ?></h3>
<hr>
...
<p><?php esc_html_e('Need Marketing Insight? ,','gravity-forms-pipedrive-crm')?> <a href="<?php echo $plugin_url ?>&section=vxc_premium"><?php esc_html_e('Go Pro!','gravity-forms-pipedrive-crm')?></a></p>
</div>
 <?php
 return;
 }
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php esc_html_e('No Information Available','gravity-forms-pipedrive-crm')?></h3>
   <?php
}
?>
</div>
